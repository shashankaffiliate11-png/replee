...
export default function LandingPage() {
  ...
  // If a session already exists (including one that just landed after an
  // OAuth redirect back to "/"), leave immediately instead of waiting for
  // the person to click something again.
  useEffect(() => {

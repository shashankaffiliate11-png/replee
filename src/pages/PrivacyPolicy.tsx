        ...
        <div className="prose-legal mt-10 space-y-8 text-sm leading-relaxed text-ink-700">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              client's record. AI generted response by NoticeDesk tool will not the final
              and its Your responsibility to review and edit the draft before sending it to the tax authorities.
              NoticeDesk does not guarantee the accuracy of the draft generated by AI and is not responsible for 
              any errors or omissions in the draft. 
              You should always review and edit the draft before sending it to the tax authorities.
            </p>
          </section>
